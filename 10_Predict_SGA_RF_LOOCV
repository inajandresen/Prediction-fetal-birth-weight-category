...
for(trim in tpoints){
  ...
  MoM_exprset_STORK_LGA_SGA <- MoM_exprset_STORK_LGA_SGA[, MoM_exprset_STORK_LGA_SGA$Bwkat %in% c("SGA", "AGA")]
  ...
  anosafe$G=factor(ifelse(anosafe$Bwkat=="SGA","D","C"))
  ...
  save(pile,freq,f1_values,f1_score,balanced_acc_values,balanced_accuracy,a_df,auc_pr,file=paste("../Predict_SGA_new/All_proteins/Predict_SGA_T",trim,"_",modtype,"_all_proteins.RData",sep=""))
}
...
for(trim in tpoints){
  ...
  freq=cbind(data.frame(stat))
  save(pile,freq,f1_values,f1_score,balanced_acc_values,balanced_accuracy,a_df,auc_pr,file=paste("../Predict_SGA_new/50_proteins/Predict_SGA_T",trim,"_",modtype,"_50_proteins.RData",sep=""))
}
...
for(trim in tpoints){
  ...
  freq=cbind(data.frame(stat))
  save(pile,freq,f1_values,f1_score,balanced_acc_values,balanced_accuracy,a_df,auc_pr,file=paste("../Predict_SGA_new/40_proteins/Predict_SGA_T",trim,"_",modtype,"_40_proteins.RData",sep=""))
}
...
for(trim in tpoints){
  ...
  freq=cbind(data.frame(stat))
  save(pile,freq,f1_values,f1_score,balanced_acc_values,balanced_accuracy,a_df,auc_pr,file=paste("../Predict_SGA_new/30_proteins/Predict_SGA_T",trim,"_",modtype,"_30_proteins.RData",sep=""))
}
...
for(trim in tpoints){
  ...
  freq=cbind(data.frame(stat))
  save(pile,freq,f1_values,f1_score,balanced_acc_values,balanced_accuracy,a_df,auc_pr,file=paste("../Predict_SGA_new/20_proteins/Predict_SGA_T",trim,"_",modtype,"_20_proteins.RData",sep=""))
}
...
for(trim in tpoints){
  ...
  freq=cbind(data.frame(stat))
  save(pile,freq,f1_values,f1_score,balanced_acc_values,balanced_accuracy,a_df,auc_pr,file=paste("../Predict_SGA_new/10_proteins/Predict_SGA_T",trim,"_",modtype,"_10_proteins.RData",sep=""))
}
...
for(trim in tpoints){
  ...
  freq=cbind(data.frame(stat))
  save(pile,freq,f1_values,f1_score,balanced_acc_values,balanced_accuracy,a_df,auc_pr,file=paste("../Predict_SGA_new/5_proteins/Predict_SGA_T",trim,"_",modtype,"_5_proteins.RData",sep=""))
}
