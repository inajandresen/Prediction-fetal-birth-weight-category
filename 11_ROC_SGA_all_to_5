...
T1_EN_freq <- freq
T1_EN_pile <- pile
T1_EN_f1_score <- f1_score
T1_EN_balanced_accuracy <- balanced_accuracy
T1_EN_auc_pr <- auc_pr
...
#50 proteins EN
load("../Predict_SGA_new/50_proteins/Predict_SGA_T1_EN_50_proteins.RData")

T1_EN_50_freq <- freq
T1_EN_50_pile <- pile
T1_EN_50_f1_score <- f1_score
T1_EN_50_balanced_accuracy <- balanced_accuracy
T1_EN_50_auc_pr <- auc_pr
...
T1_EN_50_ci_txt <- "95% CI: 0.57-0.89"


#40 proteins
load("..//Predict_SGA_new/40_proteins/Predict_SGA_T1_EN_40_proteins.RData")

T1_EN_40_freq <- freq
T1_EN_40_pile <- pile
T1_EN_40_f1_score <- f1_score
T1_EN_40_balanced_accuracy <- balanced_accuracy
T1_EN_40_auc_pr <- auc_pr
...
T1_EN_40_ci_txt <- "95% CI: 0.53-0.86"

#30 proteins EN
load("../Predict_SGA_new/30_proteins/Predict_SGA_T1_EN_30_proteins.RData")

T1_EN_30_freq <- freq
T1_EN_30_pile <- pile
T1_EN_30_f1_score <- f1_score
T1_EN_30_balanced_accuracy <- balanced_accuracy
T1_EN_30_auc_pr <- auc_pr
...
#10 proteins EN
load("../Predict_SGA_new/10_proteins/Predict_SGA_T1_EN_10_proteins.RData")
...
T1_EN_10_ci_txt <- "95% CI: 0.20-0.64"

#5 proteins EN
load("../Predict_SGA_new/5_proteins/Predict_SGA_T1_EN_5_proteins.RData")
...
T1_EN_5_ci_txt <- "95% CI: 0.25-0.65"
...
T1_EN_res$Bwkat <- ifelse(T1_EN_res$true_labels == 1, "SGA", "AGA")
...
#50 proteins EN
load("../Predict_SGA_new/50_proteins/Predict_SGA_T2_EN_50_proteins.RData")
T2_EN_50_freq <- freq
T2_EN_50_pile <- pile
...
T2_EN_50_ci_txt <- "95% CI: 0.34-0.81"


#40 proteins
load("../Predict_SGA_new/40_proteins/Predict_SGA_T2_EN_40_proteins.RData")
T2_EN_40_freq <- freq
T2_EN_40_pile <- pile
...
T2_EN_40_ci_txt <- "95% CI: 0.37-0.78"

#30 proteins EN
load("../Predict_SGA_new/30_proteins/Predict_SGA_T2_EN_30_proteins.RData")
T2_EN_30_freq <- freq
T2_EN_30_pile <- pile
...
T2_EN_30_ci_txt <- "95% CI: 0.41-0.78"
...
#10 proteins EN
load("../Predict_SGA_new/10_proteins/Predict_SGA_T2_EN_10_proteins.RData")
T2_EN_10_freq <- freq
T2_EN_10_pile <- pile
...
T2_EN_10_ci_txt <- "95% CI: 0.14-0.72"

#5 proteins EN
load("../Predict_SGA_new/5_proteins/Predict_SGA_T2_EN_5_proteins.RData")
T2_EN_5_freq <- freq
T2_EN_5_pile <- pile
...
T2_EN_5_ci_txt <- "95% CI: 0.048-0.48"
...
T2_EN_res$Bwkat <- ifelse(T2_EN_res$true_labels == 1, "SGA", "AGA")
...
#50 proteins EN
load("../Predict_SGA_new/50_proteins/Predict_SGA_T3_EN_50_proteins.RData")
T3_EN_50_freq <- freq
T3_EN_50_pile <- pile
...
T3_EN_50_ci_txt <- "95% CI: 0.11-0.67"


#40 proteins
load("../Predict_SGA_new/40_proteins/Predict_SGA_T3_EN_40_proteins.RData")
T3_EN_40_freq <- freq
T3_EN_40_pile <- pile
...
T3_EN_40_ci_txt <- "95% CI: 0.088-0.61"

#30 proteins EN
load("../Predict_SGA_new/30_proteins/Predict_SGA_T3_EN_30_proteins.RData")
T3_EN_30_freq <- freq
T3_EN_30_pile <- pile
...
T3_EN_30_ci_txt <- "95% CI: 0.057-0.56"
...
#10 proteins EN
load("../Predict_SGA_new/10_proteins/Predict_SGA_T3_EN_10_proteins.RData")
T3_EN_10_freq <- freq
T3_EN_10_pile <- pile
...
T3_EN_10_ci_txt <- "95% CI: 0.14-0.65"

#5 proteins EN
load("../Predict_SGA_new/5_proteins/Predict_SGA_T3_EN_5_proteins.RData")
T3_EN_5_freq <- freq
T3_EN_5_pile <- pile
...
T3_EN_5_ci_txt <- "95% CI: 0.43-0.94"
...
T3_EN_res$Bwkat <- ifelse(T3_EN_res$true_labels == 1, "SGA", "AGA")
...
#50 proteins RF
load("../Predict_SGA_new/50_proteins/Predict_SGA_T1_RF_50_proteins.RData")
T1_RF_50_freq <- freq
T1_RF_50_pile <- pile
...
T1_RF_50_ci_txt <- "95% CI: 0.31-0.79"


#40 proteins
load("../Predict_SGA_new/40_proteins/Predict_SGA_T1_RF_40_proteins.RData")
T1_RF_40_freq <- freq
T1_RF_40_pile <- pile
...
T1_RF_40_ci_txt <- "95% CI: 0.35-0.70"

#30 proteins RF
load("../Predict_SGA_new/30_proteins/Predict_SGA_T1_RF_30_proteins.RData")
T1_RF_30_freq <- freq
T1_RF_30_pile <- pile
...
T1_RF_30_ci_txt <- "95% CI: 0.28-0.65"
...
#10 proteins RF
load("../Predict_SGA_new/10_proteins/Predict_SGA_T1_RF_10_proteins.RData")
T1_RF_10_freq <- freq
T1_RF_10_pile <- pile
...
T1_RF_10_ci_txt <- "95% CI: 0.30-0.70"

#5 proteins RF
load("../Predict_SGA_new/5_proteins/Predict_SGA_T1_RF_5_proteins.RData")
T1_RF_5_freq <- freq
T1_RF_5_pile <- pile
...
T1_RF_5_ci_txt <- "95% CI: 0.33-0.66"
...
T1_RF_res$Bwkat <- ifelse(T1_RF_res$true_labels == 1, "SGA", "AGA")
...
#50 proteins RF
load("../Predict_SGA_new/50_proteins/Predict_SGA_T2_RF_50_proteins.RData")
T2_RF_50_freq <- freq
T2_RF_50_pile <- pile
...
T2_RF_50_ci_txt <- "95% CI: 0.36-0.89"


#40 proteins
load("../Predict_SGA_new/40_proteins/Predict_SGA_T2_RF_40_proteins.RData")
T2_RF_40_freq <- freq
T2_RF_40_pile <- pile
...
T2_RF_40_ci_txt <- "95% CI: 0.45-0.89"

#30 proteins RF
load("../Predict_SGA_new/30_proteins/Predict_SGA_T2_RF_30_proteins.RData")
T2_RF_30_freq <- freq
T2_RF_30_pile <- pile
...
T2_RF_30_ci_txt <- "95% CI: 0.42-0.88"
...
#10 proteins RF
load("../Predict_SGA_new/10_proteins/Predict_SGA_T2_RF_10_proteins.RData")
T2_RF_10_freq <- freq
T2_RF_10_pile <- pile
...
T2_RF_10_ci_txt <- "95% CI: 0.41-0.72"

#5 proteins RF
load("../Predict_SGA_new/5_proteins/Predict_SGA_T2_RF_5_proteins.RData")
T2_RF_5_freq <- freq
T2_RF_5_pile <- pile
...
T2_RF_5_ci_txt <- "95% CI: 0.42-0.70"
...
T2_RF_res$Bwkat <- ifelse(T2_RF_res$true_labels == 1, "SGA", "AGA")
...
#50 proteins RF
load("../Predict_SGA_new/50_proteins/Predict_SGA_T3_RF_50_proteins.RData")
T3_RF_50_freq <- freq
T3_RF_50_pile <- pile
...
T3_RF_50_ci_txt <- "95% CI: 0.21-0-67"


#40 proteins
load("../Predict_SGA_new/40_proteins/Predict_SGA_T3_RF_40_proteins.RData")
T3_RF_40_freq <- freq
T3_RF_40_pile <- pile
...
T3_RF_40_ci_txt <- "95% CI: 0.23-0.63"

#30 proteins RF
load("../Predict_SGA_new/30_proteins/Predict_SGA_T3_RF_30_proteins.RData")
T3_RF_30_freq <- freq
T3_RF_30_pile <- pile
...
T3_RF_30_ci_txt <- "95% CI: 0.21-0.66"
...
#10 proteins RF
load("../Predict_SGA_new/10_proteins/Predict_SGA_T3_RF_10_proteins.RData")
T3_RF_10_freq <- freq
T3_RF_10_pile <- pile
...
T3_RF_10_ci_txt <- "95% CI: 0.49-0.83"

#5 proteins RF
load("../Predict_SGA_new/5_proteins/Predict_SGA_T3_RF_5_proteins.RData")
T3_RF_5_freq <- freq
T3_RF_5_pile <- pile
...
T3_RF_5_ci_txt <- "95% CI: 0.44-0.92"
...
T3_RF_res$Bwkat <- ifelse(T3_RF_res$true_labels == 1, "SGA", "AGA")
...
ggsave(filename= "ROC_SGA_all_to_5_prots.png",
       plot = ROC_plots,
       device = "png",
...
ggsave(filename= "RF_ROC_BOX_SGA_all_to_5_prots.png",
...
ggsave(filename= "EN_ROC_BOX_SGA_all_to_5_prots.png",
...
ggsave(filename= "EN_ROC_BOX_PR_SGA_all_to_5_prots.png",
...
ggsave(filename= "RF_ROC_BOX_PR_SGA_all_to_5_prots.png",
